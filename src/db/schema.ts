// Auto-generated from schema.sql — inlined to eliminate file-path dependency
// in compiled binaries where __dirname resolves to a temp extraction directory.
// DO NOT edit schema.sql directly — edit this constant instead.
